  ...
  function (
    ...
    return Controller.extend("sap.ui.table.sample.Filtering.Controller", {
      onInit: function () {
        ...
        sap.ui.require(
          ...
          function (TableExampleUtils) {
            ...
            oTb.addContent(
              TableExampleUtils.createInfoButton(
                "sap/ui/table/sample/Filtering"
              )
            );
          },
          function (oError) {
      ...
      initSampleDataModel: function () {
        ...
        jQuery.ajax(sap.ui.require.toUrl("task/shanita/orders.json"), {
          dataType: "json",
      ...
      toggleAvailabilityFilter: function (oEvent) {
        this.byId("availability").filter(
          oEvent.getParameter("pressed") ? "X" : ""
        );
      },
